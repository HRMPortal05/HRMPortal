...
//   return (
//     <>
//       <div className="columns-2 blur-lg md:columns-3 lg:columns-4 md:mt-8 md:ml-2 lg:mt-8 lg:ml-2 md:gap-4 lg:gap-4 md:p-4 lg:p-4">
//         {imageUrls.map((url, index) => (
//           <div key={index} className="mb-4">
//             <img
//               src={url}
...
//         ))}
//       </div>
//       <div className="absolute inset-0 flex items-center justify-center md:ml-64 lg:ml-64 bg-black/5">
